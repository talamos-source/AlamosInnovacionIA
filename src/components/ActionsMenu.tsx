...
import { MoreVertical, Edit, Trash2, Eye, Wand2, Route, Archive, ArchiveRestore, Sparkles, Lightbulb } from 'lucide-react'
...
interface ActionsMenuProps {
  ...
  /** Si se pasa, muestra la acción "New Proposal Idea". Para /customers. */
  onNewProposalIdea?: () => void
  onDelete?: () => void
...
const ActionsMenu = ({ onView, onEdit, onEditContext, onGenerateRoadmap, onGenerateFicha, onNewProposalIdea, onDelete, onArchive, isArchived }: ActionsMenuProps) => {
        ...
        >
          ...
          {onNewProposalIdea && (
            <button
              type="button"
              className="actions-menu-item actions-menu-item--ai"
              onClick={() => { onNewProposalIdea(); setIsOpen(false) }}
            >
              <Lightbulb size={16} />
